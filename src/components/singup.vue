            ...
            <div class="max-w-md w-full p-6">
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    <div>
                        ...
                        <input required v-model="form.username" type="text" id="username" name="username"
                    ...
                    <div>
                        ...
                        <input v-model="form.email"
                            class="input validator mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"
                    ...
                    <div>
                        ...
                        <input type="password" v-model="form.password"
                            ...
                            required placeholder="Password" minlength="8" :pattern=pattern />
